...
const open_ap = document.getElementById("open-ap");
const airpods_3 = document.getElementById("airpods-3");

open_ap.addEventListener("click", function () {
  airpods_3.classList.toggle("show");
});
